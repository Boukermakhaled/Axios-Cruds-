  ...
  .finally(function () {
    ...
    const list = products.map((pr)=>{
        ...
        return <tr key={pr.id} className="p-4  text-xs  ">
            ...
            <td><button className="ml-5.5 cursor-pointer flex gap-0.5 items-center  bg-blightblue/90 rounded-2xl py-1.5 text-sky-200 shadow-sky-200 shadow-md px-3.5" onClick={()=>{
                seetShow(true);
                setCard(pr);
            }}><Eye size={16}/></button></td>
            <td><button className="ml-9.5 cursor-pointer flex gap-0.5 items-center  bg-bpurple rounded-2xl py-1.5 text-purple-200 shadow-purple-200 shadow-md px-3.5"><Pencil  size={16}/></button></td>
