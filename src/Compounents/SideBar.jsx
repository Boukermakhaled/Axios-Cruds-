...
export default function SideBar(){
    return(
        <div className="side flex flex-col gap-20 w-fit px-3 py-6 shadow-2xl rounded-2xl h-screen">
            <div className="profile bg-light-white p-2 w-fit border border-gray-300 rounded-2xl">
                <div className="informations flex gap-3 lg:gap-5 justify-center items-center">
                    <img src="photos/Abderrahmane.jpg" alt="" className="w-12 rounded-full" />
